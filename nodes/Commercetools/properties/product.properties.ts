...
export const productIdentificationFields: INodeProperties[] = [
	{
...
export const productDraftFields: INodeProperties[] = [
	{
...
export const productAdditionalFields: INodeProperties[] = [
	{
		...
		options: [
			{
				...
				values: [
...

					{
						...
						typeOptions: {
							validateInput:
								"={{ $json.scope === 'All' || ['Prices','Assets','Attributes','Categories','Inventory','Messages','TaxCategory'].includes($json.scope) }}",
						},
					},
